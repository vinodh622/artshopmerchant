...
export const global = StyleSheet.create({
  ...
  MenuName: {fontSize: wp('3.2%'), paddingTop: 3},
  ...
  Menu_Center: {fontSize: 12, paddingTop: 18},
  ...
  productPrice: {fontSize: 14, fontFamily: 'Helvetica-Bold', color: '#76543A'},
  ...
  pr_statusText: {color: '#8F8F8F', fontSize: wp('3.3%')},
  ...
  tabbarMenuwidth: {width: windowWidth / 5, alignItems: 'center'},
