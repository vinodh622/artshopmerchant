...
export default function Ordersummary({navigation, route}) {
  ...
  const {summaryStatus, summaryData} = getsummaryStatus;
    ...
    if (summaryStatus === 'failure') {
      ...
      return (
        <View style={global.ButtonWrapper}>
          ...
          <TouchableOpacity onPress={() => confirmSummary()}>
    ...
    if (Platform.OS === 'android') {
      Alert.alert(
        ...
        [
          ...
          {text: 'Yes', onPress: () => navigation.navigate('Printer')},
        ],
        {cancelable: false},
      );
    } else {
    ...
    fetch(CONFIRM_ORDER, {
      ...
      .then((data) => {
        ...
        if (data.status === 'success') {
          ...
          // Alert.alert(
          //   " ",
          //   "print your table details.",
          //   [

          //     { text: "Ok", onPress: () => navigation.navigate('Printer') }
          //   ],
          //   { cancelable: false }
          // );
        } else if (data.status === 'failure') {
                          ...
                          return (
                            <View style={global.summaryWrapcol2}>
                              {e.status === 2 ? (
                                <TouchableOpacity
                                  onPress={() =>
                                    confirmProductdelete(e.orderid)
                                  }>
                                ...
                                <View>
                                  <Image
                                    source={require('../../images/trashicon2.png')}
