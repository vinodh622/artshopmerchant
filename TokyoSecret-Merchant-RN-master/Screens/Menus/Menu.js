      ...
      <View style={global.innerpageContainer}>
        ...
        <View
          ...
          <View style={global.common_header_layer1}>
            ...
            <Image source={require('../../images/Logo.png')}  style={global.logo} />
        ...
        <Modal
          ...
          visible={this.state.modalvisibe2}>
            <SafeAreaView style={global.innerpageContainer}>
          ...
          <View >
            <View style={global.productImagebanner}>
              <ImageBackground
                source={{
                  uri: BASEURL +this.state.productImage,
                }}
                resizeMode="cover"
                ...
                <View style={Platform.OS=="android" ? global.pr_detailhead:global.pr_detailheadIOS } >
                  <TouchableOpacity
                    onPress={() => this.setState({modalvisibe2: false},()=>{
